...
cdef extern void slurm_env_array_merge_slurm(char ***dest_array, const_char_pptr src_array)
...
cdef inline IS_NODE_POWER_SAVE(node_info_t *_X):
...
cdef extern int parse_uint16(char *aval, uint16_t *ival)
cdef extern int parse_uint32(char *aval, uint32_t *ival)
cdef extern int parse_uint64(char *aval, uint64_t *ival)
