##############################################################################
# NOTICE: This File has been generated by the scripts/pyslurm_bindgen.py tool,
# using slurm_errno.h as the input in order to generate Cython compatible definitions
